  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        { role: "user", content: `Question: "${question}" Answer: "${answer}" Is this answer valid, appropriate, and properly formatted? Respond with a JSON object containing 'answer', 'isValid' (boolean) and 'reason' (string explaining why it's valid or invalid).` }
      ],
    });
